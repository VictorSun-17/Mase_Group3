...
MASE_HW_DEPS = {
    ...
    "activation_layers/fixed_relu6": [],
    "activation_layers/fixed_rrelu": [],
    "activation_layers/fixed_mish": ["common", "cast","linear_layers/fixed_operators", "activation_layers","memory"],
    "activation_layers/fixed_glu": ["common", "cast","linear_layers/fixed_operators", "activation_layers","memory"],
    "activation_layers/fixed_tanhshrink": ["common", "cast","linear_layers/fixed_operators", "activation_layers","memory"],
    "activation_layers/fixed_leaky_relu": [],
    "activation_layers/fixed_tanh": ["cast"],
    "activation_layers/fixed_prelu": [],
    "activation_layers/fixed_hardsigmoid": [],
    "activation_layers/fixed_hardtanh": [],
    ...
    "activation_layers/fixed_silu": ["common", "cast", "activation_layers","memory"],
    "activation_layers/fixed_elu": ["common", "cast", "activation_layers"],
    "activation_layers/fixed_sigmoid": ["common", "cast", "activation_layers","memory"],
    "activation_layers/fixed_softshrink": ["common", "cast"],
    "activation_layers/fixed_logsigmoid": ["common", "cast", "activation_layers","memory"],
